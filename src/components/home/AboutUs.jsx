    ...
    <main className="max-h-screen p-4">
      ...
      <section style={{marginTop: "4rem"}} className="flex flex-col md:flex-row">
        ...
        <div className="md:w-3/5">
          <div className="carousel w-full h-[426px] md:h-[500px] lg:h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
              <img src="/images/home/acmunsa.png" alt="Innovate" className="w-full h-full object-cover rounded-lg"/>
            ...
            <div id="slide2" className="carousel-item relative w-full">
              <img src="/images/home/unsa2.jpg" alt="Innovate" className="w-full h-full object-cover rounded-lg"/>
              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide3" className="carousel-item relative w-full">
              <img src="/images/home/unsa1.jpg" alt="Innovate" className="w-full h-full object-cover rounded-lg"/>
              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide2" className="btn btn-circle">❮</a>
                <a href="#slide1" className="btn btn-circle">❯</a>
              </div>
